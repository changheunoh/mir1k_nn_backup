...
% randIndex = rand(size(X,1),1)>0.9;
% X = X(find(randIndex==1),:);
% X_labels = X_labels(find(randIndex==1),:);
...
layers = [size(X,2), 512, 512, 512, 10];
